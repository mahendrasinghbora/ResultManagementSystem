...
marksheets.UNIVERSITY_ROLL_NUMBER AND marksheets.STATUS='1' ORDER BY COLLEGE_NAME, SUBJECT_NAME, students.UNIVERSITY_ROLL_NUMBER;"
            ...
            myReport.Load(Application.StartupPath.Replace("\bin\x64\Debug", "\Reports\CrystalReport3.rpt"))
...
marksheets.UNIVERSITY_ROLL_NUMBER AND marksheets.STATUS='1' ORDER BY COLLEGE_NAME, SUBJECT_NAME, students.UNIVERSITY_ROLL_NUMBER;"
            ...
            myData.WriteXml(Application.StartupPath.Replace("\bin\x64\Debug", "\Reports\dataset3.xml"), XmlWriteMode.WriteSchema)
        Catch ex As Exception
            MessageBox.Show(text:=ex.Message, caption:="Report could not be created.", buttons:=MessageBoxButtons.OK, icon:=MessageBoxIcon.Error)
        End Try
    End Sub
